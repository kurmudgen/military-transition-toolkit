...
# VA Disability Rating for Type 2 Diabetes: Complete Claims Guide
...
**Agent Orange/Herbicide Presumptive:**
Type 2 diabetes is presumptively associated with herbicide exposure for veterans who served in:
- Vietnam (1962-1975)
...
**The examiner will:**
1. Confirm diagnosis
2. Review treatment regimen
3. Document insulin requirements
4. Assess activity regulation
...
1. **Peripheral Neuropathy** (each extremity) - DC 8520
   - Each arm and leg rated separately
   - 10-70% per extremity

2. **Diabetic Nephropathy** - DC 7541
   - Kidney disease
   - 0-100%

3. **Diabetic Retinopathy** - DC 6006
   - Vision problems
   - Based on visual impairment

4. **Erectile Dysfunction** - DC 7522
   - Special Monthly Compensation available

5. **Coronary Artery Disease** - DC 7005
   - Heart conditions
   - 10-100%

6. **Peripheral Vascular Disease** - Various DCs
...
**Service Connection:**
[For Agent Orange]: I served in Vietnam/Thailand/Korea from [dates] and was exposed to herbicides. My Type 2 diabetes is presumptively service-connected.
...
**Complications:**
[List all—these should be claimed separately]
...
**VA Forms:**
- [DBQ Diabetes Mellitus](https://www.va.gov/find-forms/about-form-21-0960e-1/)
...
- [38 CFR § 4.119 DC 7913](https://www.ecfr.gov/current/title-38/chapter-I/part-4/subpart-B/subject-group-ECFR217de74f81c40bd/section-4.119)
