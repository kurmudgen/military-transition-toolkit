...
# VA Disability Rating for PTSD: Complete Claims Guide
...
**Why the VA recognizes PTSD:**
The VA acknowledges that military service, especially combat deployments, exposes service members to extraordinary trauma. The VA has relaxed stressor verification requirements for combat veterans, making PTSD claims more accessible.
...
**The symptoms listed are examples, not requirements:**
The VA can't deny a rating just because you don't have every listed symptom. What matters is your overall level of occupational and social impairment.
...
**For MST (Military Sexual Trauma):**
The VA uses "markers" to corroborate MST stressors when direct evidence isn't available:
...
1. **VA mental health diagnosis** from a psychiatrist or psychologist
2. **Private mental health diagnosis** with nexus statement
3. **Treatment records** showing ongoing PTSD symptoms
...
2. Ask about your military service and stressor events
3. Assess current PTSD symptoms
4. Evaluate functional impairment
5. Complete a Disability Benefits Questionnaire (DBQ)
...
1. **Describe your worst days**, not your best days
2. **Be specific with examples**: "I lost my job at XYZ company because I couldn't control my anger with my supervisor after a comment that triggered me"
3. **Quantify when possible**: "I have nightmares 4-5 times per week" not "I have frequent nightmares"
4. **Don't minimize symptoms**: This isn't the time to "suck it up"
5. **Mention all symptoms**, even embarrassing ones like hygiene issues or substance use
6. **Describe impact on relationships**: Divorce, estranged from kids, no friends
...
8. **Tinnitus** (Diagnostic Code 6260)
...
**Why it happens:** Non-combat stressors lack documentation
**How to avoid:**
...
**Why it happens:** C&P examiner diagnoses different condition or no PTSD
**How to avoid:**
...
**Why it happens:** Underreporting symptoms at exam
**How to avoid:**
...
**Why it happens:** Examiner doesn't connect your trauma to your PTSD
**How to avoid:**
...
**Why it happens:** Examiner blames childhood trauma or civilian events
**How to avoid:**
...
**Military Service:**
I served in the [Branch] from [dates] with MOS/Rating [XXX]. I deployed to [location(s)] from [dates].

**Stressor Event(s):**
[Describe the traumatic event(s) in detail. Include:]
...
After this event/these events, I began experiencing:
...
**Impact on Work:**
[Describe how PTSD has affected employment:]
- Jobs lost and why
...
[Describe how PTSD has affected relationships:]
...
[Describe how PTSD affects daily functioning:]
...
**Best for:** Errors in how evidence was evaluated
**Timeline:** ~125 days
**When to use:** If examiner ignored evidence or made clear errors
...
**Cost:** Private evaluations cost $1,500-4,000 but often worth it

### Board of Veterans Appeals
**Best for:** Complex cases requiring judge review
**Timeline:** 12-24+ months
**When to use:** When other options exhausted or case is complicated
...
- [DBQ PTSD](https://www.va.gov/find-forms/about-form-21-0960p-3/) - Form 21-0960P-3
- [DBQ Mental Disorders (other than PTSD)](https://www.va.gov/find-forms/about-form-21-0960p-2/)
- [VA Claim Application (VA Form 21-526EZ)](https://www.va.gov/find-forms/about-form-21-526ez/)
- [Statement in Support of Claim (VA Form 21-4138)](https://www.va.gov/find-forms/about-form-21-4138/)

**VA Rating Information:**
- [38 CFR § 4.130 - Schedule of Ratings, Mental Disorders](https://www.ecfr.gov/current/title-38/chapter-I/part-4/subpart-B/subject-group-ECFRa4ecc46c74d84bf/section-4.130)
- [M21-1 Adjudication Manual - PTSD](https://www.knowva.ebenefits.va.gov/system/templates/selfservice/va_ssnew/help/customer/locale/en-US/portal/554400000001018/content/554400000014205/M21-1-Part-IV-Subpart-ii-Chapter-1-Section-D-Claims-for-Service-Connection-SC-for-Post-Traumatic-Stress-Disorder-PTSD)

**Additional Support:**
- [VA PTSD Program](https://www.ptsd.va.gov/)
