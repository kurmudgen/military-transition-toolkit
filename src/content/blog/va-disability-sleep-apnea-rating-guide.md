...
# VA Disability Rating for Sleep Apnea: Complete Claims Guide
...
1. **PTSD → Sleep Apnea**: Studies show PTSD significantly increases sleep apnea risk
2. **Orthopedic conditions → Weight gain → Sleep Apnea**: Can't exercise, gained weight, developed apnea
3. **Medications → Weight gain → Sleep Apnea**: Psychiatric meds cause weight gain
4. **Rhinitis → Sleep Apnea**: Nasal obstruction contributes to apnea
5. **TBI → Sleep Apnea**: Brain injury affects sleep regulation

### Current Diagnosis Evidence

1. **Sleep study** (polysomnography or home sleep test) showing:
   - AHI (Apnea-Hypopnea Index) of 5 or higher confirms diagnosis
   - Documented oxygen desaturations
   - Sleep architecture abnormalities

2. **CPAP prescription** and records showing:
   - Date prescribed
   - Compliance data (if available)
   - Settings

3. **Treatment records** showing ongoing care for sleep apnea
...
1. **C&P examiner opinion** (requested by VA)
2. **Private physician opinion** (pay out of pocket)
3. **Independent Medical Opinion (IMO)** (specialized providers)
...
**The examiner will:**
1. Review your claims file
2. Ask about sleep apnea history and symptoms
3. Verify sleep study results
4. Confirm CPAP use
5. Assess current symptoms
6. **Provide a nexus opinion** (critical part)
...
1. **Establish timeline**: "I started having symptoms [during service/shortly after]"
2. **Confirm CPAP use**: "I use my CPAP every night"
3. **Describe symptoms**: Fatigue, daytime sleepiness, witnessed apneas
4. **For secondary claims**: Clearly explain your theory of connection
5. **Provide documentation**: Bring sleep study results, CPAP prescription
...
6. **Erectile Dysfunction** - DC 7522
   - Sleep apnea commonly causes ED
   - Often secondary

7. **Headaches/Migraines** - DC 8100
   - Morning headaches common with sleep apnea
   - Can be secondary

8. **Cognitive Disorder** - DC 8045
...
**Why it happens:** Most common denial—examiner doesn't find service connection
**How to avoid:**
...
**Why it happens:** Delayed diagnosis seen as disconnect from service
**How to avoid:**
...
**Why it happens:** Examiner attributes to post-service lifestyle
**How to avoid:**
...
**Why it happens:** No documentation of sleep issues during service
**How to avoid:**
...
**Why it happens:** VA examiner opines against connection
**How to avoid:**
...
**Military Service:**
I served in the [Branch] from [dates] with MOS/Rating [XXX].

**[CHOOSE ONE OR BOTH SECTIONS BELOW]**

**For Direct Service Connection:**
During my service, I experienced symptoms consistent with sleep apnea, including:
...
[If you have buddy statements:]
My bunkmates and fellow service members witnessed my snoring and breathing problems during sleep. [Name(s)] can attest to this in their statements.
...
My sleep apnea is secondary to my service-connected [condition]. Here is how they are connected:

[Example for PTSD:]
My service-connected PTSD has caused significant sleep disturbance since [date]. Medical research shows that PTSD increases the risk of developing sleep apnea through mechanisms including increased sympathetic nervous system activity, upper airway changes, and sleep fragmentation. My PTSD symptoms [describe how they affect sleep].

[Example for weight gain from orthopedic conditions:]
Since being service-connected for [knee/back/etc.], I have been unable to exercise due to pain and limitations. As a result, I gained approximately [X] pounds. This weight gain directly contributed to my developing sleep apnea, which is strongly correlated with obesity.

**Current Condition:**
I was diagnosed with sleep apnea on [date] via [sleep study type]. My AHI was [number], indicating [mild/moderate/severe] sleep apnea.
...
My sleep apnea affects my life in the following ways:
...
**Example for fellow service member:**
...
**Best for:** Errors in weighing evidence or clear procedural mistakes
**When to use:** If positive evidence was ignored

### Supplemental Claim
**Best for:** Adding nexus evidence
**What to submit:**
...
**When to use:** When nexus is the central issue and you have strong supporting evidence
...
- [DBQ Sleep Apnea](https://www.va.gov/find-forms/about-form-21-0960n-4/) - Form 21-0960N-4
- [VA Claim Application (VA Form 21-526EZ)](https://www.va.gov/find-forms/about-form-21-526ez/)

**VA Rating Information:**
- [38 CFR § 4.97 - Schedule of Ratings, Respiratory System](https://www.ecfr.gov/current/title-38/chapter-I/part-4/subpart-B/subject-group-ECFR222f0388dd77f4e/section-4.97)

**Medical Literature:**
- [Sleep Apnea and PTSD Connection](https://pubmed.ncbi.nlm.nih.gov/) (search "PTSD sleep apnea")
- [VA Research on Sleep Disorders](https://www.research.va.gov/)
