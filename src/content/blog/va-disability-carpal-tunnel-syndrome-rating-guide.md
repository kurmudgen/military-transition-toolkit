...
# VA Disability Rating for Carpal Tunnel Syndrome: Complete Claims Guide
...
**The examiner will:**
1. Perform Phalen's test (wrist flexion)
2. Perform Tinel's sign (tap over carpal tunnel)
3. Test grip strength
4. Check for thenar atrophy
5. Test sensation in affected fingers
6. Review EMG results
...
**Military Duties Causing CTS:**
My MOS was [XXX] which required:
...
**Symptom Onset:**
I first noticed symptoms [during service/timeframe].
