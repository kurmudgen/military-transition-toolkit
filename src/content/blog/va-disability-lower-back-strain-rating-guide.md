...
# VA Disability Rating for Lower Back Strain: Complete Claims Guide
...
**Why the VA recognizes back strain:**
Military service places extraordinary physical demands on the spine. The VA understands that even without a specific documented injury, years of wear and tear from service cause or contribute to back conditions.
...
1. **VA C&P exam diagnosis** (required for rating)
2. **Private physician diagnosis** with nexus statement
3. **Recent imaging** (X-ray, MRI, CT scan) showing:
...
2. Ask about your back history and symptoms
3. **Measure your range of motion** (this largely determines your rating)
4. Test for muscle spasm and guarding
5. Check your gait (how you walk)
6. Assess spinal contour
7. Perform neurological tests if radiculopathy is claimed
...
1. **Report where pain begins**: "I start feeling pain at about 45 degrees"
2. **Describe functional loss**: "After bending a few times, I can barely move"
3. **Explain your worst days**: "During flare-ups, I can barely get out of bed"
4. **Mention all symptoms**: pain, stiffness, muscle spasm, radiation into legs
5. **Describe impact on daily life**: "I can't sit for more than 30 minutes"
...
1. **Radiculopathy (Lower Extremity)** - Diagnostic Codes 8520-8530
...
7. **Depression/Anxiety** - Diagnostic Code 9434, 9400
...
9. **Bladder/Bowel Dysfunction** - Various codes
...
**Why it happens:** C&P exam doesn't find diagnosable condition
**How to avoid:**
- Get private diagnosis with imaging before filing
- Bring copies of MRI/X-ray reports to exam

### 2. "No nexus to service"
**Why it happens:** Examiner attributes back condition to aging or civilian causes
**How to avoid:**
...
**Why it happens:** Good day at exam, pushed through pain
**How to avoid:**
...
**Military Service and Physical Demands:**
I served in the [Branch] from [dates] with MOS/Rating [XXX]. My duties required significant physical demands that impacted my lower back, including:
...
**In-Service Back Problems:**
[Describe any documented treatment, sick calls, or injuries:]
- Date(s) of treatment and what was done
- Any profiles or duty limitations
- Specific injury events

[If no documentation:]
I did not always seek treatment for back pain during service because [explain: mission demands, didn't want to seem weak, thought it would heal, etc.]. However, I experienced [describe symptoms] during service.

**Current Condition:**
Today, I experience the following symptoms:
...
**Flare-ups:**
My back condition flares up approximately [frequency—weekly, monthly, etc.]. During flare-ups:
...
My back condition affects my daily life in the following ways:
...
**Medical Treatment:**
I currently receive the following treatment for my back:
...
**Best for:** Examiner errors in measuring ROM or ignoring flare-ups
**When to use:** If you believe the exam was inadequate or evidence was ignored
...
**Best for:** Complex cases or significant disagreement
**When to use:** If HLR and Supplemental options exhausted
...
- [DBQ Back (Thoracolumbar Spine)](https://www.va.gov/find-forms/about-form-21-0960m-14/) - Form 21-0960M-14
- [VA Claim Application (VA Form 21-526EZ)](https://www.va.gov/find-forms/about-form-21-526ez/)

**VA Rating Information:**
- [38 CFR § 4.71a - Schedule of Ratings, Musculoskeletal System](https://www.ecfr.gov/current/title-38/chapter-I/part-4/subpart-B/subject-group-ECFR4625e831b4795bc/section-4.71a)
- [General Rating Formula for Diseases and Injuries of the Spine](https://www.ecfr.gov/current/title-38/chapter-I/part-4/subpart-B/subject-group-ECFR4625e831b4795bc/section-4.71a#p-4.71a(General%20Rating%20Formula%20for%20Diseases%20and%20Injuries%20of%20the%20Spine))

**Additional Support:**
- [VA Back Pain Information](https://www.va.gov/WHOLEHEALTHLIBRARY/tools/back-pain.asp)
