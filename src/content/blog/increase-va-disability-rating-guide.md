...
1. **They don't require proving the primary condition is service-connected** (that's already done)
2. **They often qualify for their own ratings** (each can be 0%-100%)
3. **The VA is legally required to consider them** if you provide evidence
4. **They add up fast** in VA math
...
1. **A current diagnosis** from a doctor
2. **Medical records showing the condition** and its severity
3. **A nexus letter** linking the secondary condition to your primary service-connected condition
...
(See our [complete guide to nexus letters](/blog/va-nexus-letter-complete-guide) for more on this.)
...
**New Combined Rating:**
Using VA's combined rating table:
...
Look up your condition in the [VA's Schedule for Rating Disabilities](https://www.ecfr.gov/current/title-38/chapter-I/part-4). Each condition has specific criteria for different rating percentages. Identify which criteria you now meet for a higher rating.
...
- Use our [VA Disability Calculator](https://militarytransitiontoolkit.com/calculator/va-disability) to model how new ratings would affect your combined rating
...
**Ready to see how secondary conditions could increase your rating?** Use our free [VA Disability Calculator](/calculator/va-disability) to estimate your potential combined rating and monthly payment with additional conditions.

**Need help understanding VA disability claims?** Check out our [complete guide to VA nexus letters](/blog/va-nexus-letter-complete-guide)—the single most important piece of evidence for secondary conditions.
