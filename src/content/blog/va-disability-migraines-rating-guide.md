...
# VA Disability Rating for Migraines: Complete Claims Guide
...
**Why the VA recognizes migraines:**
Military service creates numerous conditions that trigger or cause chronic migraines. TBI alone significantly increases migraine risk, and many veterans have documented head trauma from their service.
...
**Prostrating attack:**
A headache severe enough that you must stop what you're doing and lie down or otherwise cease activity. You cannot function normally during a prostrating attack. This is not just a bad headache—it's one that incapacitates you.

**Characteristic prostrating attacks:**
Migraines with typical features such as:
...
Your migraines significantly impair your ability to work. This doesn't mean you must be unemployable—it means your migraines cause meaningful work impairment such as:
- Missed workdays
...
1. **VA C&P exam diagnosis**
2. **Private neurologist diagnosis** with nexus statement
3. **Documented migraine characteristics:**
...
**The examiner will:**
1. Review your claims file and medical records
2. Ask about headache history and characteristics
3. Assess frequency, duration, and severity
4. Evaluate impact on work and daily activities
5. Determine if attacks are prostrating
6. Complete the Headache (including Migraine) DBQ
...
1. **Quantify frequency**: "I have prostrating migraines 3-4 times per month"
2. **Describe prostration**: "I have to lie in a dark room, can't function, sometimes vomit"
3. **State duration**: "Each attack lasts 6-12 hours, sometimes into the next day"
4. **Explain work impact**: "I miss 2-3 workdays per month and struggle to focus even with mild headaches"
5. **Mention all symptoms**: Don't forget nausea, light sensitivity, aura
...
**Why it happens:** Examiner doesn't find attacks severe enough
**How to avoid:**
...
**Why it happens:** Not enough documented attacks
**How to avoid:**
...
**Why it happens:** No in-service documentation or connection
**How to avoid:**
...
**Why it happens:** Work impact not documented
**How to avoid:**
...
**Why it happens:** Symptoms don't meet migraine criteria
**How to avoid:**
...
**Military Service and Migraine Onset:**
I served in the [Branch] from [dates]. During my service, [describe relevant incidents]:
...
[If claiming secondary:]
My migraines are secondary to my service-connected [TBI/cervical strain/PTSD/etc.]. [Explain connection].

**Current Migraine Frequency:**
I currently experience prostrating migraines approximately [number] times per [week/month]. Over the past [6-12 months], I have had approximately [total number] prostrating attacks that forced me to stop all activities.

**Characteristics of My Migraines:**
...
- [X] Nausea
- [X] Vomiting
- [X] Extreme light sensitivity (photophobia)
- [X] Extreme sound sensitivity (phonophobia)
- [X] Visual aura (describe: flashing lights, blind spots, etc.)
- [X] Dizziness or vertigo
- [X] Difficulty thinking or concentrating

**Prostrating Nature:**
During a migraine attack, I am completely incapacitated. I must:
...
**Economic Impact:**
My migraines significantly affect my ability to work:
...
**Daily Life Impact:**
Between attacks, I [describe any ongoing symptoms]. During attacks, I cannot [list activities]. I have had to give up [activities you can no longer do].
...
**Best for:** If examiner didn't properly consider prostrating nature or frequency
**When to use:** Evidence was present but misinterpreted

### Supplemental Claim
**Best for:** Adding new evidence
**What to submit:**
...
**Best for:** Complex cases, especially for 50% rating appeals
**When to use:** If HLR unsuccessful and you have strong evidence of economic inadaptability
...
- [DBQ Headaches (Including Migraine Headaches)](https://www.va.gov/find-forms/about-form-21-0960c-8/)
- [VA Claim Application (VA Form 21-526EZ)](https://www.va.gov/find-forms/about-form-21-526ez/)

**VA Rating Information:**
- [38 CFR § 4.124a - Schedule of Ratings, Neurological Conditions](https://www.ecfr.gov/current/title-38/chapter-I/part-4/subpart-B/subject-group-ECFRba10cb97ff26d58/section-4.124a)

**Additional Support:**
- [VA Headache Centers of Excellence](https://www.va.gov/headache/)
