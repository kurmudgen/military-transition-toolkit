...
# VA Disability Rating for Knee Conditions: Complete Claims Guide
...
1. **VA C&P exam findings**
2. **Private orthopedic evaluation** with nexus statement
3. **Current imaging:**
...
2. Ask about injury history and current symptoms
3. **Measure range of motion** (critical for rating)
4. Test for **instability** (ligament stress tests)
5. Check for swelling, tenderness, crepitus
6. Assess gait and need for assistive devices
7. Test repetitive motion (3 times) and note any changes
...
1. **Report where pain begins**: "I feel pain starting at about 90 degrees of flexion"
2. **Describe instability symptoms**: "My knee gives way when I walk downstairs"
3. **Mention all symptoms**: Pain, swelling, locking, catching, grinding, giving way
4. **Describe functional limitations**: "I can't run, kneel, or squat"
5. **Explain flare-ups**: "After walking a mile, my knee swells and I can barely bend it"
6. **Don't forget to mention brace use**: If you wear a brace, bring it and explain why
...
**Why it happens:** No documented pathology found
**How to avoid:**
- Get imaging (X-ray, MRI) before filing
- Document specific diagnosis, not just "knee pain"

### 2. "No nexus to service"
**Why it happens:** Examiner attributes to aging or other causes
**How to avoid:**
...
**Why it happens:** Measurements didn't reach compensable levels
**How to avoid:**
...
**Why it happens:** Knee was stable during testing
**How to avoid:**
...
**Why it happens:** Knee problems documented before service
**How to avoid:**
...
I served in the [Branch] from [dates] with MOS/Rating [XXX]. My duties placed significant stress on my knees, including:
...
[If documented:]
On [date], I [describe injury/incident]. I was treated at [location] and [describe treatment]. I received [profile/limitations] as a result.

[If limited documentation:]
During service, I experienced [describe symptoms]. I [did/didn't seek treatment because...]. The physical demands continued to affect my knees throughout my service.

**Current Condition:**
Today, my [left/right/both] knee(s) cause the following problems:
...
**Flare-ups:**
My knee condition flares up approximately [frequency]. Triggers include [activities, weather, etc.]. During flare-ups:
...
**When to use:** If claiming multiple ratings for one knee is denied
...
- [DBQ Knee and Lower Leg](https://www.va.gov/find-forms/about-form-21-0960m-9/) - Form 21-0960M-9
...
- [VAOPGCPREC 23-97](https://www.va.gov/ogc/opinions/1997opinions.asp) - Separate ratings for arthritis and instability
- [VAOPGCPREC 9-98](https://www.va.gov/ogc/opinions/1998opinions.asp) - Separate ratings for flexion and extension
