...
# VA Disability Rating for Cognitive Disorder: Complete Claims Guide
...
**Onset:**
I began noticing cognitive problems [timeframe] following [TBI event/development of sleep apnea/etc.].
...
1. **Get neuropsychological testing** if not done
2. **Challenge if examiner didn't consider all deficits**
3. **Submit additional evidence** of functional impairment
4. **Document real-world impact** vs. test performance
...
- [VA TBI Program](https://www.polytrauma.va.gov/)
- [38 CFR § 4.124a DC 8045](https://www.ecfr.gov/current/title-38/chapter-I/part-4/subpart-B/subject-group-ECFRba10cb97ff26d58/section-4.124a)
