...
1. Create login.gov account (new requirement)
2. Complete full profile
3. Upload documents to account
4. Build and save resumes (multiple versions)
...
**Resume Requirements:**
Federal resumes are DIFFERENT than private sector:
...
**Common Mistake:**
Rating yourself too low. If you can perform the task, don't underrate. But don't lie—false claims can disqualify you.
...
3. Specify job series and grades
4. Indicate geographic preferences
...
**How It Works:**
1. Contact current supervisor about transfer possibility
2. Identify positions at new location
3. Work with HR at both ends
4. May be competitive or non-competitive depending on position
...
**This Website:**
- [Military Spouse Preference Guide](/resources/msp)
