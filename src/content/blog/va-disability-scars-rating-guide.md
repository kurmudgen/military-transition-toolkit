...
# VA Disability Rating for Scars: Complete Claims Guide
...
1. Scar 5 or more inches (13 cm) in length
...
6. Skin texture abnormal (irregular, atrophic, shiny, scaly) in area exceeding 6 square inches
7. Underlying soft tissue missing in area exceeding 6 square inches
8. Skin indurated and inflexible in area exceeding 6 square inches
...
1. **Each painful scar = 10%**: If you have 5 painful scars, that's 30%
2. **Scars can be rated under multiple codes**: A large, painful scar could get ratings under both DC 7801 and DC 7804
3. **Surgical scars count**: Scars from surgery to treat service-connected conditions are service-connected
4. **Measure all scars**: Small scars might not seem significant but can add up
5. **Document instability**: If scars frequently break open or bleed, document it
...
1. **C&P exam documentation**
2. **Photographs of all scars:**
   - Include a ruler for size reference
   - Multiple angles
   - Close-up and wider shots

3. **Medical records describing:**
...
2. Ask about each scar's origin
3. **Measure each scar** (length, width, area)
4. Assess depth (deep vs. superficial)
5. Check for pain on examination
6. Check for instability
7. Assess surface characteristics (texture, contour, adhesion)
8. Evaluate any functional limitation
9. For head/face/neck scars, assess disfigurement characteristics

**What to tell them:**

1. **Identify every scar**: Point out all service-related scars, even small ones
2. **Report all painful scars**: "This scar hurts when touched/when wearing clothes"
3. **Describe instability**: "This scar breaks open about once a month"
4. **Explain functional limitations**: "This scar limits how far I can bend my knee"
5. **Don't forget hidden scars**: Scars under clothing, on back, etc.
...
**Why it happens:** No documentation linking scar to service
**How to avoid:**
...
**Why it happens:** Pain or instability not reported at exam
**How to avoid:**
...
**Why it happens:** Scar too small for size-based ratings
**How to avoid:**
...
**Why it happens:** Examiner didn't find limitation of motion
**How to avoid:**
...
**Why it happens:** Underlying condition wasn't service-connected
**How to avoid:**
...
**Daily Impact:**
My scars affect my daily life in the following ways:
...
**Treatment:**
I have received the following treatment for my scars:
...
**Best for:** Measurement errors, missed scars, ignored symptoms
**When to use:** If examiner didn't properly document all scars or characteristics

### Supplemental Claim
**Best for:** Adding evidence of pain, instability, or missed scars
**What to submit:**
...
**Best for:** Complex cases involving multiple scars
**When to use:** If HLR unsuccessful
...
- [DBQ Scars/Disfigurement](https://www.va.gov/find-forms/about-form-21-0960f-1/) - Form 21-0960F-1
- [VA Claim Application (VA Form 21-526EZ)](https://www.va.gov/find-forms/about-form-21-526ez/)

**VA Rating Information:**
- [38 CFR § 4.118 - Schedule of Ratings, Skin](https://www.ecfr.gov/current/title-38/chapter-I/part-4/subpart-B/subject-group-ECFR2c7beaa7d4a6f9d/section-4.118)
