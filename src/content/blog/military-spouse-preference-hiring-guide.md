...
**The Reality:**
These programs work—when you know how to use them. Many spouses don't understand the different programs or how to properly claim preference, losing their competitive advantage.
...
**What It Is:**
DoD-specific hiring preference for positions within the Defense Department
...
**What It Is:**
Automatic consideration for DoD positions matching your qualifications
...
**What It Is:**
Non-competitive hiring authority for all federal agencies
...
**What It Is:**
Many states have military spouse preference for state jobs
...
1. Create/update profile indicating military spouse status
2. Answer "Yes" to military spouse questions
3. Select "Eligible for Military Spouse Preference"
4. Upload documentation (PCS orders, marriage certificate)

**On Non-USA Jobs DoD Applications:**
1. Indicate MSP eligibility on application
2. Provide required documentation
3. May need to complete separate MSP form
...
**Selection Process:**
1. HR reviews applications for minimum qualifications
2. Hiring manager interviews qualified candidates
3. If MSP spouse is among "best qualified," they get preference
4. MSP spouse selected over other equally qualified external candidates
...
1. Google: "[State name] military spouse hiring preference"
2. Check state HR or personnel office website
3. Look for "military" or "veteran" sections
4. Contact state HR office directly
...
**This Website:**
- [Federal Job Search Guide](/resources/federal-jobs)
- [Resume Guide for Military Spouses](/resources/resume)
