...
# VA Disability Rating for Military Sexual Trauma (MST): Complete Claims Guide
...
1. **Personal statement** describing the MST and resulting symptoms
...
3. **Service records showing markers**
4. **Medical records** showing treatment for related conditions
...
1. Ask about the MST stressor event
2. Assess current symptoms
3. Evaluate functional impairment
4. Provide nexus opinion
...
**Immediate effects:**
After the incident, I [describe changes]:
- [Requested transfer, changed behavior, started drinking, etc.]
- [Mental health symptoms that began]
- [Performance changes]
- [Relationship changes]

**Why I didn't report (if applicable):**
[Fear of retaliation, shame, chain of command issues, didn't think would be believed, etc.]

**Markers in my service:**
[List any changes in behavior, performance, transfers, medical visits that occurred after the incident]
...
**VA MST Coordinators:**
Every VA medical center has an MST Coordinator who can help you access care and navigate the claims process. Ask for them by name.

**Free MST-Related Care:**
Veterans can receive FREE mental and physical health care for conditions related to MST—even without a VA disability claim or award.
...
2. **Higher-Level Review** if evidence was misinterpreted

3. **Board of Veterans Appeals** for complex cases
...
**VA Forms:**
- [DBQ PTSD](https://www.va.gov/find-forms/about-form-21-0960p-3/)
...
**VA MST Information:**
- [VA MST Website](https://www.mentalhealth.va.gov/msthome/index.asp)
- [38 CFR § 3.304(f)(5)](https://www.ecfr.gov/current/title-38/chapter-I/part-3/subpart-A/subject-group-ECFR8f15e8eb7ee0dc4/section-3.304)

**Support Organizations:**
- [Protect Our Defenders](https://www.protectourdefenders.com/)
- [Service Women's Action Network](https://www.servicewomen.org/)
