...
Use the [career planning tools at Military Transition Toolkit](https://militarytransitiontoolkit.com) to translate your military experience into civilian job titles and explore career options.
...
**How to file BDD:**
1. **Go to eBenefits or VA.gov** and start your claim.
2. **Upload supporting documents:** medical records, service treatment records, buddy statements, private medical records.
3. **Attend your C&P exams** (VA will schedule them).
4. **Follow up** to ensure nothing's missing.
...
**Actions:**
- **Finalize your civilian resume** (get it reviewed by a professional or use our [resume builder](https://militarytransitiontoolkit.com)).
...
Use our [Military Transition Toolkit](https://militarytransitiontoolkit.com) to:
...
**Start your transition plan today.** Use the [interactive checklist at Military Transition Toolkit](https://militarytransitiontoolkit.com/resources) to track every step from 12 months out to your first civilian job.
