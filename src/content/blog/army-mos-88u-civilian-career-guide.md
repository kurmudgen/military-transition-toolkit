...
**Canadian National (CN)** - U.S. operations (Midwest, South)
**Canadian Pacific Kansas City (CPKC)** - U.S. operations (Midwest, Texas, Louisiana)
...
**Senior engineer or conductor-engineer:** $95,000-$120,000+
**Yardmaster / Trainmaster:** $80,000-$110,000
**Chief dispatcher:** $95,000-$125,000
...
1. **"Operated military locomotives and conducted 500+ train movements including switching operations, train assembly, and rail transportation with zero safety incidents"**

2. **"Performed railcar coupling/uncoupling, switch operations, and train consist assembly following strict safety protocols and operating rules"**

3. **"Inspected locomotives and railcars for mechanical defects, safety compliance, and operational readiness ensuring equipment met standards"**

4. **"Coordinated train movements via radio communications and hand signals with crews, operations personnel, and supervision"**

5. **"Operated in all weather conditions (extreme heat, cold, rain, snow) maintaining mission-critical rail operations"**

6. **"Maintained train documentation including consists, inspection records, and movement authorities ensuring regulatory compliance"**

7. **"Trained 8 junior operators on locomotive operation, switching procedures, safety protocols, and railroad operating rules"**

8. **"Responded to 20+ emergency situations (equipment failures, operational issues) making critical decisions ensuring safety"**
...
1. Online application and assessment tests
2. Phone interview or in-person interview
3. Background check (comprehensive—railroads check criminal, employment, driving records)
4. Drug test (mandatory—railroads are safety-sensitive, zero-tolerance)
5. Medical examination (vision, hearing, physical capability tests)
6. Job offer and training start date
...
1. **Underestimating lifestyle demands** - On-call, irregular schedules, nights/weekends are standard
2. **Expecting 9-5 work** - Railroads operate 24/7; expect to work holidays, nights, weekends
3. **Not researching specific railroads** - Culture, territories, and opportunities vary
4. **Failing drug tests** - One failure = permanent ban from railroad industry
5. **Quitting during training** - Training is intensive; some wash out. Commit mentally.
6. **Ignoring transit alternatives** - Urban rail offers similar work with better lifestyle
7. **Not understanding seniority systems** - Railroad advancement based on seniority (years of service), not performance alone
...
**Ready to start your railroad operations career?** Use the [Military Transition Toolkit](https://militarytransitiontoolkit.com) to track your job search and career progress.
