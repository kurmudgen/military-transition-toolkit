...
**Clinical positions:** Add credentialing time (can be significant)
**Positions requiring clearance:** Add investigation time
...
GS-9 → GS-10 → GS-11 → GS-12 (Nurse Manager) → GS-13 (Nurse Executive)

**Benefits (VSR example):**
GS-7 → GS-9 → GS-10 (VSR) → GS-11/12 (RVSR/Coach) → GS-13 (Supervisor)

**Administrative:**
GS-7 → GS-9 → GS-11 → GS-12 → GS-13 → GS-14/15 (Executive)
...
1. **Identify your target administration:** VHA, VBA, or NCA based on skills/interests
2. **Research specific positions:** Find roles matching your military experience
3. **Build federal resume:** Emphasize veteran perspective and relevant skills
4. **Claim all eligibilities:** VRA, 30% disabled, VEOA, preference
5. **Apply strategically:** Focus on positions with strong match
...
*Interested in other federal agencies? Explore careers at [DoD Civilian](/blog/dod-civilian-careers-veterans-guide), [DHS](/blog/dhs-careers-veterans-guide), or [FBI](/blog/fbi-careers-veterans-guide).*
