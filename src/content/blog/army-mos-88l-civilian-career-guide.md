...
**Maersk Line Limited** - U.S.-flag, MSC contracts, excellent veteran hiring
**American President Lines (APL)** - Container ships
**Matson Navigation** - Pacific trade routes
**Crowley Maritime** - Tankers, cargo ships, tugs
**OSG America** - Petroleum tankers
**Liberty Maritime** - Tanker operations
**Intrepid Personnel and Provisioning** - Crewing agency

### Offshore Supply Vessels

**Tidewater Inc.** - Largest OSV operator
**Edison Chouest Offshore** - Major Gulf of Mexico operator
**Hornbeck Offshore Services** - OSV fleet
**Harvey Gulf International Marine** - Offshore support
**SEACOR Marine** - Offshore vessels
**Swire Pacific Offshore** - International operations

### Tugboat / Inland Waterways

**Kirby Corporation** - Largest tank barge operator (engineers on larger vessels)
**Crowley Maritime** - Harbor tugs and towing
**Foss Maritime** - Pacific Coast operations
**Moran Towing** - East Coast harbors
**McAllister Towing** - Harbor tugs

### Ferries / Passenger Vessels

**Washington State Ferries** - Largest U.S. ferry system
**Alaska Marine Highway** - State ferry system
**Massachusetts Bay Transportation Authority** - Boston ferries
**Various regional ferry systems**
...
**NOAA (National Oceanic and Atmospheric Administration)** - Research vessels
**U.S. Army Corps of Engineers** - Dredges and survey vessels
**State maritime agencies**

### Shipyards & Technical Support

**Vigor Industrial** - Ship repair, Pacific Northwest
**BAE Systems** - Naval and commercial ship repair
**Huntington Ingalls Industries** - Shipbuilding and repair
**General Dynamics NASSCO** - San Diego
**Philly Shipyard**
**Electric Boat** - Submarine builder (technical support roles)
**All major commercial and naval shipyards nationwide**

### Classification Societies & Marine Services

**American Bureau of Shipping (ABS)** - Surveyors, technical staff
**Det Norske Veritas (DNV)** - Classification services
**Lloyd's Register** - Marine surveys
**Marine survey firms** (hundreds of independent firms nationwide)
...
**MAN Energy Solutions** - Large diesels
**Numerous pump, generator, and equipment manufacturers**
...
1. **"Operated and maintained marine diesel propulsion systems (500-1500 HP) and auxiliary generators on military watercraft with 99% uptime across 5,000+ engine hours"**

2. **"Stood engine room watches monitoring propulsion, electrical, hydraulic, and auxiliary systems; responded to 50+ system casualties with zero mission failures"**

3. **"Performed preventive maintenance on diesel engines, generators, pumps, reduction gears, and electrical systems following technical manuals and maintenance schedules"**

4. **"Troubleshot and repaired mechanical, electrical, and hydraulic system failures using schematics, multimeters, and diagnostic equipment with 95% first-time fix rate"**

5. **"Supervised engine room crew of 3-5 personnel conducting maintenance, repairs, and watchstanding with perfect safety record"**

6. **"Managed vessel spare parts inventory ($200K+), ordered supplies, and coordinated with maintenance teams ensuring operational readiness"**

7. **"Welded and fabricated emergency repairs on propulsion and auxiliary systems maintaining vessel availability during deployed operations"**

8. **"Maintained detailed engineering logs, equipment records, and maintenance documentation ensuring regulatory compliance"**

9. **"Diagnosed and repaired fuel injection systems, cooling systems, lubrication systems, and generator controls minimizing downtime"**

10. **"Trained 10+ junior engineers on propulsion systems, maintenance procedures, and troubleshooting techniques"**
...
1. **Not documenting military sea time properly** - Get detailed records before separating
2. **Skipping STCW training** - Required for most positions; complete early
3. **Expecting immediate Chief Engineer positions** - Career progression takes 5-15 years
4. **Underestimating exam difficulty** - USCG engineer exams are comprehensive; study seriously
5. **Not networking with veteran engineers** - They provide invaluable transition advice
...
**Ready to launch your marine engineering career?** Use the [Military Transition Toolkit](https://militarytransitiontoolkit.com) to track your licensing progress.
