...
tags: ["transition-planning", "timeline", "6-months", "separation"]
readTime: 8
---
...
1. Verify current job search status (have 3-5 prospects?)
2. Identify any gaps in transition planning
3. Create action plan for any missing pieces
4. Schedule appointment with TAP counselor if needed
