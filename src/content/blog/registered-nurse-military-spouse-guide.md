...
1. **Start prerequisites online** during first year at a duty station
2. **Complete program** at stable duty station (3+ year tour)
3. **Use clinical placement services** rather than program-specific hospitals
4. **Document everything** for credit transfer if PCS unavoidable
...
1. **Declare primary residence** in a compact state
2. **Apply in that state** (your home state)
3. **Pass NCLEX-RN** examination
4. **Receive multistate license** valid in all compact states
