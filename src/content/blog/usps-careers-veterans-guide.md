...
1. Hired as non-career (CCA, PSE, etc.)
2. Work variable hours, build seniority
3. Convert to career when positions open
4. Full benefits and job security
...
**After conversion to career:** ~$22-$35/hour over time
...
**Vehicle allowance:** Equipment Maintenance Allowance (EMA) for personal vehicle
...
Most common path:
1. **Start non-career** (CCA, RCA, PSE, MHA)
2. **Work 1-2 years** (varies by location)
3. **Convert to career** when position opens
4. **Full benefits and seniority** begin
...
*Interested in other federal employment? Return to [federal employment overview](/categories/federal-employment) or explore [DoD civilian](/blog/dod-civilian-careers-veterans-guide) positions.*
