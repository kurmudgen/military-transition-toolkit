...
# VA Disability Rating for Shoulder Conditions: Complete Claims Guide
...
**Fibrous union of humerus:** 50% (major), 40% (minor)
**Nonunion of humerus (false flail joint):** 60% (major), 50% (minor)
**Loss of head of humerus (flail shoulder):** 80% (major), 70% (minor)
...
2. Ask about shoulder history and current symptoms
3. **Measure range of motion** (critical)
4. Test strength
5. Check for instability
6. Assess for impingement and rotator cuff integrity
7. Review imaging
8. Test repetitive motion (3 times)
...
1. **Report where pain begins**: "I start feeling pain at about 70 degrees when raising my arm"
2. **Describe weakness**: "I can't lift more than 10 pounds overhead"
3. **Mention instability**: "My shoulder feels like it's going to pop out when I reach"
4. **Explain flare-ups**: "After using my arm a lot, I can barely move it the next day"
5. **Note all symptoms**: Pain, weakness, grinding, catching, popping
6. **Identify dominant arm**: Make sure the examiner knows which is your dominant arm
...
1. **Cervical (Neck) Strain** - DC 5237
   - Compensating for shoulder causes neck problems
   - Same nerve roots involved
   - Can be secondary

2. **Radiculopathy (Upper Extremity)** - DC 8510-8512
...
4. **Opposite Shoulder Condition**
   - Overcompensating with good shoulder
   - Claim aggravation

5. **Scars** - DC 7800-7805
...
**Why it happens:** Examination doesn't show pathology
**How to avoid:**
...
**Why it happens:** Measured ROM at exam doesn't qualify for higher rating
**How to avoid:**
...
**Why it happens:** Examiner didn't note or used wrong arm
**How to avoid:**
- Clearly state which arm is dominant
- Verify correct documentation at exam

### 5. "Pre-existing condition"
**Why it happens:** Shoulder problems before service
**How to avoid:**
...
I served in the [Branch] from [dates] with MOS/Rating [XXX]. My duties placed significant stress on my shoulders, including:
...
**In-Service Shoulder Problems:**
[Describe documented injuries, treatment, or events:]
On [date], I [describe injury/incident]. I received treatment at [location] and was [diagnosed with/treated for]. I was [given profile/limitations].

[If limited documentation:]
During service, I experienced [symptoms] from the physical demands. I [did/didn't seek treatment because].
...
**Flare-ups:**
My shoulder condition flares up approximately [frequency]. Triggers include [activities, weather, etc.]. During flare-ups:
...
**Best for:** Examiner errors in ROM measurement, wrong dominant arm noted
**When to use:** If evidence supports claim but wasn't properly considered
...
**Best for:** Complex cases or significant rating disputes
**When to use:** After HLR if still not satisfied
...
- [DBQ Shoulder and Arm](https://www.va.gov/find-forms/about-form-21-0960m-12/)
...
- [38 CFR § 4.71, Plate I - Range of Motion](https://www.ecfr.gov/current/title-38/chapter-I/part-4/subpart-B/subject-group-ECFRa4ecc46c74d84bf/section-4.71)
