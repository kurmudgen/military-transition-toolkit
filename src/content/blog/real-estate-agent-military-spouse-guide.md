...
**Strategy for Military Spouses:**
Take courses for your current state, but check if they'll transfer to likely future states. Many online providers offer "career" packages that include courses for multiple states.
...
**How It Works:**
1. Client contacts you about buying in another state
2. You refer them to a trusted agent there
3. You earn 25-35% of that agent's commission at closing
4. You do minimal work but maintain the relationship
...
**Cost:** ~$200 (includes training course)
**Time:** 1-2 day course
...
- [Portable Careers](/resources/portable-careers)
