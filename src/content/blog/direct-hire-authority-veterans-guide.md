...
1. Applications rated and ranked numerically
2. Veterans preference points added to scores
3. Certificates issued with ranked candidates
4. Detailed selection documentation required
5. Extensive procedural compliance

**Under DHA:**
1. Applications assessed for basic qualifications
2. Any qualified candidate can be selected
3. No ranked certificates required
...
Search for "direct hire" or "direct hire authority" in USAJOBS:
- May appear in job title or announcement text
- Not all DHA positions are labeled clearly

**Method 2: Target High-DHA Fields**
Focus on occupational series with known DHA:
...
**Method 3: Look for Indicators**
DHA announcements often include:
...
**Method 4: Agency Career Pages**
Some agencies prominently feature DHA positions:
...
**Best resources:**
- [DCPAS Career Portal](https://www.dcpas.osd.mil)
...
*Looking for more federal hiring options? Explore [VRA](/blog/vra-veterans-recruitment-appointment-guide) and [30% disabled veteran authority](/blog/30-percent-disabled-veteran-hiring-guide) for non-competitive paths.*
