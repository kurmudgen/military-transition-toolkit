...
# VA Disability Rating for Panic Disorder: Complete Claims Guide
...
1. Panic attack characteristics
...
1. **Agoraphobia** - Fear of places where panic might occur
2. **Depression** - Commonly co-occurs
3. **GERD** - Stress affects digestive system
4. **Sleep Disorders** - Anxiety disrupts sleep
5. **Substance Use** - Self-medication
...
**First Panic Attack:**
My first panic attack occurred on approximately [date] during [circumstance]. I experienced [describe symptoms].

**Frequency:**
I currently have panic attacks approximately [X] times per [week/month]. [Keep a log and attach it]

**Symptoms During Attacks:**
During a panic attack, I experience:
- [List physical symptoms]
- [List psychological symptoms]
- Duration: approximately [X] minutes

**Avoidance:**
Due to fear of panic attacks, I avoid:
