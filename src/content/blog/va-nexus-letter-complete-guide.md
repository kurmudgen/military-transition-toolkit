...
A nexus letter is a medical opinion letter from a qualified healthcare provider that establishes a connection (the "nexus") between your current medical condition and your military service.

The VA needs three things to grant service connection:
1. **A current diagnosed condition** (your medical records)
2. **An in-service event, injury, or illness** (your service records)
3. **A link between the two** (this is your nexus letter)
...
But you definitely need a nexus letter when:
...
Didn't go to sick call for that back injury because your unit was deploying and you didn't want to get left behind? You're not alone, but now you need a medical professional to review your service history and provide an opinion that the injury likely occurred during service.
...
The provider must be qualified to diagnose and treat your specific condition. For PTSD, that means a psychiatrist or clinical psychologist—not your primary care doc. For orthopedic issues, an orthopedic surgeon or sports medicine physician carries more weight than a general practitioner.
...
If the letter doesn't explicitly state what records were reviewed, the VA can reject it.
...
- "May be connected..." (the VA will deny this)
...
You have several options, and prices vary wildly:
...
No legitimate medical provider can guarantee the VA will approve your claim. Anyone promising guaranteed results is lying.
...
Send your doctor:
- The VA's [Adequate Medical Evidence fact sheet](https://www.benefits.va.gov/compensation/dbq_publicdbqs.asp)
...
Once you have your nexus letter, don't just upload it to VA.gov and pray. Here's how to use it strategically:
...
1. **Evaluate your claim**: Does it need a nexus letter? (If you're filing more than a year after service, for secondary conditions, or with incomplete records, yes.)

2. **Decide DIY vs. professional**: Can your current doctor write an adequate letter, or do you need a professional IMO service?

3. **Vet the provider**: Check credentials, read reviews, avoid scams and guarantees.

4. **Ensure completeness**: The letter must include credentials, record review, clear nexus opinion, medical rationale, and specific details.

5. **Submit strategically**: Don't wait for a denial—include the nexus letter with your initial claim.

6. **Use our VA claims tools**: Track your claim, estimate your rating, and connect with verified VSOs at [Military Transition Toolkit](https://militarytransitiontoolkit.com).
...
**Need help with your VA claim?** Check out our [VA Disability Calculator](/calculator/va-disability) to estimate your potential rating and monthly payment based on your conditions.
