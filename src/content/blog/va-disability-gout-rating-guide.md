...
# VA Disability Rating for Gout: Complete Claims Guide
...
**The examiner will:**
1. Review medical records and labs
2. Examine affected joints
3. Assess frequency of attacks
4. Review medications
5. Order or review X-rays
6. Measure range of motion if joint damage
...
**Service Connection:**
My gout [was diagnosed during service/developed secondary to service-connected (condition)/began after service due to (connection)].

**Attack History:**
I experience gout attacks approximately [X] times per year.

**Recent attacks:**
- [Date]: Affected [joint], lasted [duration]
- [Date]: Affected [joint], lasted [duration]
[List attacks from past year]
...
**VA Forms:**
- [DBQ Arthritis](https://www.va.gov/find-forms/) - search for appropriate form
- [VA Form 21-526EZ](https://www.va.gov/find-forms/about-form-21-526ez/)

**VA Rating Information:**
- [38 CFR § 4.71a DC 5017, 5002](https://www.ecfr.gov/current/title-38/chapter-I/part-4/subpart-B/subject-group-ECFR4625e831b4795bc/section-4.71a)
