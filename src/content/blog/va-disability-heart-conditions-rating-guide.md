...
# VA Disability Rating for Heart Conditions: Complete Claims Guide
...
**The examiner will:**
1. Review cardiac history
2. Review all diagnostic testing
3. Conduct physical examination
4. Perform METs assessment (exercise test or interview-based)
5. Review medications
6. Assess functional limitations

**METs Assessment:**
The examiner will determine your METs level either by:
...
3. Include diagnosis of ischemic heart disease
4. No nexus letter required for presumptive claims
...
**Service Connection:**
[For Agent Orange]: I served in Vietnam/[qualifying location] from [dates]. I have been diagnosed with ischemic heart disease.
...
[Describe how heart condition affects your daily activities]
...
### Denial Reasons
1. METs testing shows greater than 10 METs
2. No nexus to service (for non-presumptive claims)
3. Condition attributed to non-service factors
...
**VA Forms:**
- [DBQ Heart Conditions](https://www.va.gov/find-forms/about-form-21-0960a-2/)
- [VA Form 21-526EZ](https://www.va.gov/find-forms/about-form-21-526ez/)

**Agent Orange Information:**
- [VA Agent Orange Website](https://www.va.gov/disability/eligibility/hazardous-materials-exposure/agent-orange/)

**VA Rating Information:**
- [38 CFR § 4.104 - Cardiovascular System](https://www.ecfr.gov/current/title-38/chapter-I/part-4/subpart-B/subject-group-ECFR2cf4960ff01a68d/section-4.104)
