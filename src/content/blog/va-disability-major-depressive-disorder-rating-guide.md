...
# VA Disability Rating for Major Depressive Disorder: Complete Claims Guide
...
You don't need every listed symptom. What matters is your overall level of occupational and social impairment.
...
**Example secondary connection:**
"Veteran's chronic lower back pain (service-connected) has limited his mobility, caused sleep disturbance, and prevented him from engaging in activities he previously enjoyed. These factors have directly contributed to the development of major depressive disorder."

### Current Diagnosis Evidence

1. **VA mental health evaluation** diagnosing MDD
2. **Private psychiatrist or psychologist diagnosis** with nexus statement
3. **Treatment records showing:**
   - Ongoing therapy
...
2. Ask about onset of depression symptoms
3. Assess current symptom severity
4. Evaluate occupational and social impairment
5. Complete a Mental Disorders DBQ
...
2. **Give specific examples**: "I called in sick 15 days last year because I couldn't get out of bed"
3. **Mention suicidal thoughts** if you've had them—this is important for 70% rating
4. **Describe relationship impacts**: "My wife left because I became withdrawn and irritable"
5. **Don't minimize**: This isn't the time to be stoic
...
3. **Sleep Disorders** - DC 6847, 8108
   - Depression affects sleep
   - Sleep deprivation worsens depression

4. **Chronic Pain Conditions** (claim MDD secondary to these)
...
7. **Erectile Dysfunction** - DC 7522
...
**Why it happens:** Examiner can't connect depression to service
**How to avoid:**
...
**Why it happens:** C&P examiner diagnoses different condition or no MDD
**How to avoid:**
...
**Why it happens:** Examiner blames civilian life events
**How to avoid:**
...
**Why it happens:** Pre-service mental health history
**How to avoid:**
...
**For Direct Service Connection:**
During my service in the [Branch] from [dates], I experienced [describe circumstances that contributed to depression]:
...
My major depressive disorder is secondary to my service-connected [condition]. Since developing this condition, I have experienced:
...
**Current Symptoms:**
I currently experience the following symptoms of depression:
...
**Best for:** Errors in evaluating evidence
**When to use:** If examiner ignored evidence or made factual errors
...
**When to use:** When other options exhausted
