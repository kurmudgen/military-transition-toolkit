...
1. **Apply with your county property appraiser.** Each of Florida's 67 counties handles this. Don't go to the tax collector—wrong office.
...
3. **Apply by March 1** for exemption to take effect that tax year. Miss that deadline, you're waiting another year.

4. **Reapply if your rating changes.** If you go from 70% to 100%, you need to update it.

### For C.W. Bill Young tuition waiver:

1. **Contact the financial aid office** at your school.
2. **Submit DD-214** and proof of Florida residency at discharge.
3. **Apply each semester.** It's not automatic.

### For hunting/fishing licenses:

1. **Go to MyFWC.com** (Florida Fish and Wildlife Conservation Commission).
2. **Upload VA award letter** showing disability rating.
3. **Get instant approval** for free licenses.

### For state park passes:

1. **Visit any state park office.**
2. **Show VA ID and Florida driver's license.**
3. **Get your annual pass.**

Use our [benefits tracker at Military Transition Toolkit](https://militarytransitiontoolkit.com) to keep all your documentation organized and set reminders for renewal dates.
...
1. **Visit before you commit.** Take leave, visit in August (worst weather), see if you can handle it. Check out different cities.

2. **Run your numbers.** Use our [military retirement calculator](https://militarytransitiontoolkit.com) to see your actual tax savings.

3. **Connect with local veterans.** Join Facebook groups for veterans in the cities you're considering. Ask real questions.

4. **Plan your transition timeline.** If you're getting out, coordinate terminal leave with your move. If you're retiring, think about where you want to land first.

5. **Line up your benefits.** Don't wait until after you move to start the paperwork. Know what you need to file and when.
...
**Ready to plan your move?** Use the [transition checklist at Military Transition Toolkit](https://militarytransitiontoolkit.com/resources) to track every step from separation to settling in your new home state.
