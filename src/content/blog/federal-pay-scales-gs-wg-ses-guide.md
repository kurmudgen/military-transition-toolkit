...
**Steps:** 1 through 10 within each grade
**Locality pay:** Added on top of base pay (varies by location)
...
**Grades:** WG-1 through WG-15
**Also includes:** WL (Leader) and WS (Supervisor) levels
...
**Pay range:** Currently $147,649 to $221,900 (2024)
**No steps:** Pay is set individually
**Performance-based:** Annual adjustments based on performance
...
**San Francisco GS-12 Step 5:** $118,527
**Rest of US GS-12 Step 5:** $96,257
**Difference:** $22,270
...
**How to request:**
1. After receiving a job offer, request a higher step in writing
2. Document your superior qualifications:
   - Certifications
   - Specialized experience
   - Current salary (if higher)
   - Competing job offers
3. Agency must approve—but many do
...
### OPM Resources
- **[GS Pay Calculator](https://www.opm.gov/policy-data-oversight/pay-leave/salaries-wages/)** – Official pay tables
- **[Locality Pay Tables](https://www.opm.gov/policy-data-oversight/pay-leave/salaries-wages/2024/general-schedule/)** – Find your area
- **[FWS Pay Tables](https://www.opm.gov/policy-data-oversight/pay-leave/pay-systems/federal-wage-system/)** – Wage Grade rates

### Third-Party Tools
- **[FederalPay.org](https://www.federalpay.org)** – Easy-to-use calculators
- **[GovLoop](https://www.govloop.com)** – Federal career community
- **[FedSmith](https://www.fedsmith.com)** – Federal employee news and resources
...
**Key takeaways:**
1. **GS-11 to GS-13** is where most veterans with 4-10 years of service will qualify
2. **Locality pay adds 17-44%** to your base salary—location matters
3. **Career ladder positions** offer guaranteed promotions
4. **Military retirement plus federal salary** is a powerful combination
5. **Negotiate for higher steps** using Superior Qualifications authority
6. **Buy back your military time** for your FERS pension

Understanding federal pay gives you the power to target the right positions and negotiate effectively.

---

*Ready to find federal positions at your target grade? Check out our [USAJOBS guide](/blog/usajobs-complete-guide-veterans) or explore [agency-specific career guides](/categories/federal-employment).*
