    ...
    <div className="max-w-4xl mx-auto p-4 md:p-8">
      ...
      <div className="mb-6 flex flex-col md:flex-row gap-4">
        ...
        <div className="md:w-48">
          <select
            ...
            className="w-full px-4 py-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg text-gray-900 dark:text-white focus:outline-none focus:border-blue-500 transition-colors cursor-pointer"
          >
      ...
      <div className="space-y-6">
        {filteredAndSortedPosts.map(post => (
          <article
            key={post.slug}
            className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-500 transition-all"
          >
      ...
      {allPosts.length === 0 && (
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-12 border border-gray-200 dark:border-gray-700 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">Check back soon for transition guides and resources!</p>
        </div>
      )}
