...
import { applyRateLimit, apiRateLimit } from '../_middleware/ratelimit.js'
...
export default async function handler(req, res) {
  ...
  // 🔒 SECURITY: Apply API rate limiting (100 requests per minute)
  // Prevents portal session abuse - PENTEST-001 fix
  const rateLimitOk = await applyRateLimit(req, res, apiRateLimit)
