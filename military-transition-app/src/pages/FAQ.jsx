        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-800/50 rounded-lg border border-slate-700 overflow-hidden">
            ...
            <details className="border-t border-slate-700 group">
              ...
              <div className="p-4 pt-0 text-slate-300">
                <strong>All premium features are FREE until the government shutdown ends</strong>. We had planned to offer free access through Veterans Day, but with veterans potentially impacted by the shutdown, we're extending free premium access until federal operations resume. Service members, veterans, and military families have enough to worry about - focus on your transition, we've got the rest covered. You can still lock in Founding Member lifetime pricing at $249 (save $150 off the future $399 price).
              </div>
            </details>
